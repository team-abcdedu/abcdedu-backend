...
public class SurveyReq {
    ...
    public record Create(
            @NotBlank
            @Schema(example = "수업 만족도 조사", description = "50자 까지 입력 가능합니다. 빈 값 불가입니다.")
            @Length(max = 50)
            String title,
            ...
            @Schema(example = """
                ...
                """, description = "300자까지 입력 가능합니다.")
            @Length(max = 300)
            String additionalDescription,

            @NotNull
            List<SurveyQuestionReq.Create> questions
    ) {
