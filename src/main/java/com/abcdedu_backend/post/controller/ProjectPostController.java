...
public class ProjectPostController {
    ...
    @GetMapping("/")
    @Operation(summary = "프로젝트 게시글 목록", description = "프로젝트 게시글을 조회합니다.")
    public Response<List<PostListResponse>> readAllProjectPost() {
        Pageable pageable = PageRequest.of(0, 10, Sort.by("id").descending());
        List<PostListResponse> allPosts = postService.getAllPosts(pageable, "project");
    ...
    public Response<Long> addPost(@Valid @RequestBody PostCreateRequest req,
        ...
        return Response.success(postService.createPost(req, memberId,"project"));
    }
}
