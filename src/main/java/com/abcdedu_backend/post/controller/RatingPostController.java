...
public class RatingPostController {
    ...
    @GetMapping("/")
    @Operation(summary = "등업 게시글 목록", description = "등업 게시글을 조회합니다.")
    public Response<List<PostListResponse>> readAllRatingPost() {
        Pageable pageable = PageRequest.of(0, 10, Sort.by("id").descending());
        List<PostListResponse> allPosts = postService.getAllPosts(pageable, "rating");
    ...
    public Response<Long> addPost(@Valid @RequestBody PostCreateRequest req,
        ...
        return Response.success(postService.createPost(req, memberId,"rating"));
    }
