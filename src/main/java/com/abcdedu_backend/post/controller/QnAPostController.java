...
public class QnAPostController {
    ...
    @GetMapping("/")
    @Operation(summary = "QnA 게시글 목록", description = "QnA 게시글을 조회합니다.")
    public Response<List<PostListResponse>> readAllQnAPost() {
        Pageable pageable = PageRequest.of(0, 10, Sort.by("id").descending());
        List<PostListResponse> allPosts = postService.getAllPosts(pageable, "qna");
    ...
    public Response<Long> addPost(@Valid @RequestBody PostCreateRequest req,
        ...
        return Response.success(postService.createPost(req, memberId,"qna"));
    }
